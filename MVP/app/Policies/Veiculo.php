...
class VeiculoPolicy
{
    ...
    {
        return $user->hasPermissionTo('Listar Veículos');
    }
    ...
    {
        return $user->hasPermissionTo('Criar Veículos');
    ...
    {
        return $user->hasPermissionTo('Editar Veículos');
    ...
    {
        return $user->hasPermissionTo('Excluir Veículos');
